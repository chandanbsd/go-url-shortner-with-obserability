...
func (s *server) handlerShortenLink(w http.ResponseWriter, r *http.Request) {
	...
	globalErrorLogger.Printf("Parsed URL: scheme=%s, host=%s", u.Scheme, u.Host)
	...
	globalErrorLogger.Printf("Generated short code: %s for URL: %s", shortCode, longURL)
...
func (s *server) handlerRedirect(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, store.ErrNotFound) {
			...
			globalErrorLogger.Printf("failed to lookup URL: %v", err)
...
func (s *server) handlerListURLs(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		globalErrorLogger.Printf("failed to list URLs: %v", err)
